if [[ `uname` == "Linux" ]]; then
  ...
  export ANDROID_HOME=/home/mssun/program/android-sdk
  export ANDROID_NDK_HOME=/opt/android-ndk
  export PATH="$ANDROID_NDK_HOME:$ANDROID_NDK_HOME/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin:$ANDROID_HOME/tools:$ANDROID_HOME/platform-tools:$ANDROID_HOME/build-tools/23.0.2/:$PATH"
