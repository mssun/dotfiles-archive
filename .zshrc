...
if [[ `uname` == "Linux" ]]; then
    ...
    export no_proxy="localhost,127.0.0.1,127.0.0.0/8,137.189.88.0/22,192.168.0.0/16,.cse.cuhk.edu.hk"
fi
...
# added by travis gem
[ -f /home/mssun/.travis/travis.sh ] && source /home/mssun/.travis/travis.sh
